    ...
    for BATCH_SIZE in [16, 32, 64]:
        for num_epoch in [1, 2 ,3]:
            ...
            for fold_, (train_index, test_index) in enumerate(folds.split(train_df, train_df['label'])):
                ...
                train_fold = train_fold.drop(columns=['tweet','clean_tweet' ,'tokenized_tweet', 'tokenized_tweet_no_stopwords', 'text'])
                test_fold = test_fold.drop(columns=['tweet', 'clean_tweet', 'tokenized_tweet', 'tokenized_tweet_no_stopwords', 'text'])
